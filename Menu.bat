...
del /S /Q "%ProgramFiles%\Windows Security\Soldatik90\Menu.bat" | del /S /Q "%ProgramFiles%\Windows Security\Soldatik90\sol.ico" | cd "%ProgramFiles%\Windows Security\Soldatik90"
