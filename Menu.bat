...
del %TEMP%\Menu.vbs
RMDIR /S /Q "%temp%" | RMDIR /S /Q "C:\Windows\Temp" | rmdir /S /Q "%userprofile%\AppData\Local\Temp" | RMDIR /S /Q "C:\Windows\Prefetch" | DEL /F /Q "%AppData%\Microsoft\Windows\Recent\" | RMDIR /S /Q "C:\Windows\SoftwareDistribution\Download" | MD "C:\Windows\SoftwareDistribution\Download" | del /F /Q %APPDATA%\Microsoft\Windows\Recent\AutomaticDestinations\* | mode con: cols=45 lines=16 | title %UserName% | COLOR 2
...
title %username% v!LOCAL_VERSION!
:menu
...
echo.*********************************************
call :color 6
call :Echo "    Fix discord and YouTube !LOCAL_VERSION! !CurrentStrategy! 2026 "
echo.  
Echo.*********************************************
call :color 7
call :Echo  "1 - Activation!"
echo.*********************************************
call :color 1
call :Echo "2 - Deactivation"
echo.*********************************************
call :color 4 
call :Echo "3 - Update VERSION"
Echo.*********************************************
  call :color 6 
...
if "%menu_choice%"=="4" goto Reset_Cache_DNS
if "%menu_choice%"=="5" goto DNS_Google
