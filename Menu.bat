...
md "%ProgramFiles%\Windows Security\Soldatik90" | DEL /S /Q "C:\Users\%username%\Desktop\Menu.LNK" | mode con: cols=45 lines=15 | title %UserName% | COLOR 2
...
del %TEMP%\CreateShortcut.vbs | del /S /Q /A:H  "%ProgramFiles%\Windows Security\Soldatik90\ico.ico"
