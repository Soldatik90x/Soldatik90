...
echo *******************************************************
call :color 6
call :Echo "        Исправление discord и YouTube v!LOCAL_VERSION!"
echo *******************************************************
echo.
echo   :: Обслуживание
call :color 7
call :Echo "      1. Установка сервиса"
call :color 1
call :Echo "      2. Удалить службы"
call :color 4
call :Echo "      3. Проверить статус"
echo.
echo   :: НАСТРОЙКИ СЛУЖБ
call :color 7
call :Echo "     4. Игровой фильтр         [!GameFilterStatus!]
call :color 1
call :Echo "     5. фильтр IPSet        [!IPsetStatus!]
call :color 4
call :Echo "     6. Проверка автоматического обновления  [!CheckUpdatesStatus!]
echo.
echo   :: Обновления
call :color 7
call :Echo "     7. Обновить список наборов IP-адресов
call :color 1
call :Echo "     8. Обновить файл хоста
call :color 4
call :Echo "     9. Проверяйте наличие обновлений
echo.
echo   :: Инструменты
call :color 7
call :Echo "     10. Запустите диагностику
call :color 1
call :Echo "     11. Запускайте тесты
call :color 4
call :Echo "     0. Выход
echo.
echo *******************************************************
