...
powershell -executionpolicy bypass -command Invoke-WebRequest "https://github.com/Flowseal/zapret-discord-youtube/releases/download/1.9.0/zapret-discord-youtube-1.9.0.zip" -o "Soldatik90.zip"
